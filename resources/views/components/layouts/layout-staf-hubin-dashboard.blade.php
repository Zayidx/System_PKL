{{-- ========================================================================================= --}}
{{-- FILE 1: Layout Utama (layout-staf-hubin-dashboard.blade.php) --}}
{{-- LOKASI: resources/views/components/layouts/layout-staf-hubin-dashboard.blade.php --}}
{{-- ANALISIS: --}}
...
<head>
    ...
    <title>{{ $title ?? 'Dasbor Staf Hubin' }}</title>
