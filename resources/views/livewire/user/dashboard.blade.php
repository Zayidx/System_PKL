    ...
    <div class="dashboard-layout">
            ...
            <div class="dashboard-card">
                ...
                <div class="dashboard-card-body p-2">
                    <nav class="nav flex-column quick-nav">
                        <a class="nav-link" href="{{ route('user.pengajuan') }}"><i class="bi bi-buildings icon"></i> Daftar Perusahaan</a>
                        <a class="nav-link" href="{{ route('user.ajukan-perusahaan-baru') }}"><i class="bi bi-building-add icon"></i> Ajukan Perusahaan Baru</a>
        ...
        <div class="d-flex flex-column gap-4">
            ...
            @if($prakerinData->isEmpty() && $pengajuanDiterimaData->isEmpty())
                <a href="{{ route('user.pengajuan') }}" class="btn btn-primary shadow-sm mt-3"><i class="bi bi-search me-2"></i>Cari Tempat Magang</a>
            @endif
            ...
            <div class="dashboard-card">
                ...
                <div class="list-group list-group-flush activity-list p-0">
                    @forelse($recentPengajuan as $pengajuan)
                        <div class="list-group-item" @if($pengajuan->status_pengajuan !== 'pending') style="cursor:pointer" onclick="window.location='{{ route('user.pengajuan.proses', ['id_perusahaan' => $pengajuan->id_perusahaan]) }}'" @endif>
