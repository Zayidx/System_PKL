{{-- Tampilan formulir login multi-peran dengan feedback validasi. --}}
<div id="auth-left">
    ...
    <form wire:submit='attemptLogin' novalidate>
        ...
        <p class="m-0 mt-5 text-xl text-center text-dark">
            Belum punya akun? Sini <a href="{{ route('daftar') }}" class="text-primary fw-bold text-decoration-underline" wire:navigate>Daftar dulu</a>
        </p>
        <p class="m-0 mt-2 text-center">
            <a href="{{ route('lupa-sandi') }}" class="text-danger fw-bold text-decoration-underline" wire:navigate>Lupa Password?</a>
        </p>
    </form>
</div>
