{{-- Form usulan perusahaan baru oleh siswa untuk ditinjau staf. --}}
{{-- Ganti kode view Anda dengan kode di bawah ini --}}
{{-- Lokasi file: resources/views/livewire/pengguna/ajukan-perusahaan-baru.blade.php --}}
        ...
        <div class="card-body p-4 p-md-5">
            ...
            <form wire:submit.prevent="submit" novalidate>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <a href="{{ route('pengguna.pengajuan') }}" class="btn btn-danger" wire:navigate>
