{{-- Daftar perusahaan dan modal pengajuan magang termasuk opsi perusahaan manual. --}}
<div>
    <div class="card shadow-sm">
        ...
        <div class="card-body py-4">
            <div class="mb-3">
                <a href="{{ route('pengguna.ajukan-perusahaan-baru') }}" class="btn btn-primary">Ajukan Perusahaan Baru</a>
            </div>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="card h-100 shadow-sm border">
                            ...
                            @else
                                ...
                                @if(!$showModal)
                                    <a href="{{ route('pengguna.pengajuan.proses', ['id_perusahaan' => $perusahaan->id_perusahaan]) }}"
