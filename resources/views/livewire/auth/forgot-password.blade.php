<div id="auth-left">
        ...
        @if (!$showOtpForm && !$showResetForm)
            ...
            <form wire:submit='submitEmail' novalidate>
                ...
                <p class="m-0 mt-5 text-xl text-center text-dark">
                    <a href="{{ route('login') }}" class="text-primary fw-bold text-decoration-underline" wire:navigate>Kembali ke Login</a>
                </p>
            </form>
    ...
    @else
        ...
        <p class="mt-3 text-center"><a href="{{ route('login') }}" class="btn btn-primary">Kembali ke Login</a></p>
    @endif
</div>
