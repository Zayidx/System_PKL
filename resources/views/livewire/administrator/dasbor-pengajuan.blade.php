{{-- Ringkasan pengajuan per kelas untuk monitoring awal administrator. --}}
<div>
            ...
            <div wire:loading.delay.class="opacity-50 transition-opacity" class="row g-4">
                @forelse($kelasList as $kelas)
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <a href="{{ route('staf-hubin.data.pengajuan.kelas', ['id_kelas' => $kelas->id_kelas]) }}" class="text-decoration-none text-dark">
