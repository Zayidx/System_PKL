{{-- Detail status pengajuan seorang siswa lengkap dengan aksi approval/penolakan. --}}
<div class="">
    <div class="page-heading">
    <div class="d-flex justify-content-between align-items-center">
        <nav aria-label="breadcrumb" class="d-none d-md-block">
            <ol class="breadcrumb my-0">
                <li class="breadcrumb-item"><a href="{{ route('staf-hubin.dasbor') }}">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="{{ route('staf-hubin.data.pengajuan.kelas', ['id_kelas' => $siswa->kelas->id_kelas]) }}">Daftar Siswa</a></li>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ route('staf-hubin.data.nilai.kelas', ['id_kelas' => $siswa->kelas->id_kelas]) }}" class="btn btn-outline-warning btn-sm">
