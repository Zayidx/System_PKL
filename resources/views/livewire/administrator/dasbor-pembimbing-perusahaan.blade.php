{{-- Daftar pembimbing perusahaan dengan aksi tambah/edit serta penautan ke perusahaan. --}}
<div>
    <style>
        ...
        <div class="card-body">
            <div class="d-flex mb-4 justify-content-between align-items-center flex-wrap">
                <div class="d-flex gap-2 mb-2 mb-md-0">
                    ...
                    <input type="search" wire:model.live.debounce.300ms="search" class="form-control" placeholder="Cari nama, email, perusahaan...">
                </div>
                            ...
                            <tr wire:key="{{ $p->id_pembimbing }}">
                                ...
                                <td class="text-center">
                                    <div class="d-inline-flex gap-1">
                                        <button class="btn btn-warning btn-sm" wire:click="edit({{ $p->id_pembimbing }})"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-danger btn-sm" wire:click="$dispatch('swal:confirm', { id: {{ $p->id_pembimbing }}, method: 'destroy-pembimbing' })"><i class="bi bi-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                        @empty
                            <tr><td colspan="7" class="text-center py-4">Tidak ada data pembimbing yang ditemukan.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
                    ...
                    <form wire:submit.prevent="store">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <select class="form-select @error('id_perusahaan') is-invalid @enderror" id="id_perusahaan" wire:model.defer="id_perusahaan">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" wire:model.defer="no_hp">
                                @error('no_hp') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>
                            <div class="col-12"><hr class="my-2"></div>
                            <h6 class="mb-3 px-3">Informasi Akun (Role: Pembimbing Perusahaan)</h6>
                            <div class="col-12 mb-3">
