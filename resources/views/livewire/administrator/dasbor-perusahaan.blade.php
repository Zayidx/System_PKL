{{-- Halaman administrasi perusahaan mitra termasuk upload logo dan kontak. --}}
<div>
                ...
                <table class="table table-hover table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            {{-- Hilangkan tag penutup yang tidak diperlukan --}}
                            <th>Email</th>
                    ...
                    <tbody>
                        ...
                        @empty
                            {{-- Colspan diselaraskan dengan jumlah kolom tabel --}}
