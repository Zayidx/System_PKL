{{-- Daftar penilaian PKL dengan filter status dan jurusan serta ringkasan nilai. --}}
<div>
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('administrator.data.kompetensi') }}" class="btn btn-secondary">
                            ...
                            @forelse($penilaian as $index => $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @if($item->jumlah_kompetensi > 0)
                                            <a href="{{ route('administrator.data.penilaian-pkl.detail', $item->id_penilaian) }}" 
