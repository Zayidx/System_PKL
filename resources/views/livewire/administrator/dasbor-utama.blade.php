{{-- Tampilan dasbor administrator yang memuat statistik global, aktivitas pengajuan terbaru, dan tautan manajemen cepat. --}}
<div>
    {{--
        File: resources/views/livewire/administrator/dasbor-utama.blade.php
                    ...
                    <div class="card">
                        ...
                        <div class="card-body management-links">
                            <div class="list-group list-group-flush">
                                <a href="{{ route('administrator.data.siswa') }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                    Manajemen Siswa <i class="bi bi-chevron-right"></i>
                                </a>
                                <a href="{{ route('administrator.data.guru') }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                    Manajemen Guru <i class="bi bi-chevron-right"></i>
                                </a>
                                <a href="{{ route('administrator.data.perusahaan') }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                    Manajemen Perusahaan <i class="bi bi-chevron-right"></i>
                                </a>
                                <a href="{{ route('administrator.data.jurusan') }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
                                    Manajemen Jurusan <i class="bi bi-chevron-right"></i>
                                </a>
                                <a href="{{ route('administrator.data.pengguna') }}" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center">
