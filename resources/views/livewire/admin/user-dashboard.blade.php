{{-- ========================================================================================= --}}
{{-- FILE VIEW LIVEWIRE: Tampilan Komponen (Versi Perbaikan Lanjutan) --}}
{{-- Path: resources/views/livewire/admin/user-dashboard.blade.php --}}
{{-- ANALISIS PERUBAHAN: --}}
{{-- 1. [PERBAIKAN] Menambahkan tanda bintang (*) merah pada label Foto Profil untuk --}}
{{--    menandakan bahwa field tersebut wajib diisi saat membuat user baru. --}}
{{-- ========================================================================================= --}}
<div>
    <style>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="store">
                        ...
                        <div class="mb-3">
                            {{-- [PERBAIKAN] Menambahkan tanda bintang (*) jika user baru (wajib) --}}
