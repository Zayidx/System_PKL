{{-- Dasbor staf hubin menampilkan metrik, histori pengajuan, dan pusat manajemen. --}}
<div class="container-fluid py-2" x-data="dashboardChart()" wire:poll.15s>
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="fw-bold mb-1">Dashboard Staf Hubin</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('staf-hubin.data.pengajuan.siswa', ['nis' => $p->siswa->nis ?? '']) }}" class="btn btn-sm btn-outline-primary icon" title="Lihat Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
