{{-- Detail status prakerin siswa dan penugasan pembimbing sekolah. --}}
<div>
    <a href="{{ route('staf-hubin.data.prakerin.kelas', ['id_kelas' => $siswa->id_kelas]) }}" class="btn btn-link p-2 mb-3 bg-primary text-white text-decoration-none"><i class="bi bi-arrow-left"></i> Kembali ke Daftar Siswa</a>
