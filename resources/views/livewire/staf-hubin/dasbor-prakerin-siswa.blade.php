{{-- Daftar siswa dalam kelas yang sudah memiliki prakerin. --}}
<div>
    <a href="{{ route('staf-hubin.data.prakerin') }}" class="btn btn-link p-2 mb-3 bg-primary text-white text-decoration-none"><i class="bi bi-arrow-left"></i> Kembali ke Daftar Kelas</a>
                        ...
                        @forelse($siswaList as $siswa)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('staf-hubin.data.prakerin.status', ['nis' => $siswa->nis]) }}" class="btn btn-primary btn-sm">
