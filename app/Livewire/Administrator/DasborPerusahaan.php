...
// Namespace disesuaikan dengan struktur folder yang benar
...
/**
 * Modul admin untuk mengelola perusahaan mitra:
 * - Menyediakan daftar dengan pencarian dan paginasi.
 * - Mengatur unggahan logo, kontak, serta penautan pembimbing sekolah.
 * - Memastikan data lama dibersihkan ketika diperbarui/dihapus.
 */
class DasborPerusahaan extends Component
{
    ...
    protected function rules()
    {
        ...
        return [
            ...
            // Validasi kontak disesuaikan: gunakan numeric, panjang 10-15 digit, dan wajib unik.
            'kontak_perusahaan' => [
                'required', 
                'numeric', 
    ...
    public function render()
    {
        ...
        return view('livewire.administrator.dasbor-perusahaan', [
    ...
    {
        // Pastikan 'kontak_perusahaan' ikut direset agar nilai lama tidak tersisa saat modal dibuka ulang.
