...
/**
 * Modul admin untuk mengelola jurusan sekolah:
 * - Menyediakan daftar dengan statistik jumlah kelas dan siswa per jurusan.
 * - Menawarkan CRUD lewat modal, termasuk memilih kepala program yang bertanggung jawab.
 * - Menjaga konsistensi data dengan validasi unik dan pemeriksaan relasi sebelum hapus.
 */
class DasborJurusan extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.administrator.dasbor-jurusan', [
    ...
    /**
     * Membuka modal dalam keadaan kosong untuk menambahkan jurusan baru.
     */
    ...
    /**
     * Mengisi formulir dengan data jurusan yang dipilih agar bisa diperbarui.
     */
    ...
    /**
     * Menutup modal dan membersihkan input & error agar siap dipakai ulang.
     */
    ...
    /**
     * Mereset seluruh properti formulir ke nilai awal.
     */
