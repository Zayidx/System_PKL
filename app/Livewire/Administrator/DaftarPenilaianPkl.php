...
/**
 * Dashboard daftar penilaian PKL untuk administrator:
 * - Menyediakan filter jurusan dan status penyelesaian kompetensi.
 * - Menghitung statistik nilai (rata-rata, tertinggi, terendah) secara dinamis.
 * - Menampilkan data lengkap dengan relasi siswa, pembimbing, dan perusahaan.
 */
class DaftarPenilaianPkl extends Component
{
    ...
    /**
     * Reset paginasi saat kata kunci berubah agar hasil kembali ke halaman awal.
     */
    ...
    /**
     * Reset paginasi ketika filter jurusan diubah.
     */
    ...
    /**
     * Reset paginasi ketika filter status penyelesaian diubah.
     */
    ...
    /**
     * Menyusun query penilaian beserta filter & agregasi nilai sebelum
     * diteruskan ke tampilan Livewire.
     */
    public function render()
    {
        ...
        return view('livewire.administrator.daftar-penilaian-pkl', [
            'penilaian' => $penilaian,
            'jurusan' => $jurusan
        ]);
    }
