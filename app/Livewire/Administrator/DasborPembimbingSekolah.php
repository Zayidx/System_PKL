...
/**
 * Mengelola akun serta profil pembimbing sekolah:
 * - Menyediakan daftar dengan pencarian lintas kolom (nama, NIP, kontak, perusahaan terkait).
 * - Mengemas proses tambah/edit via modal yang menyingkronkan data user (akun login) dan entitas pembimbing.
 * - Mengurus unggahan foto profil beserta penghapusan file lama untuk menghindari berkas yatim.
 * - Memberi umpan balik ke UI menggunakan event SweetAlert setelah operasi berhasil.
 */
class DasborPembimbingSekolah extends Component
{
    ...
    /**
     * Menyusun query daftar pembimbing dengan eager loading user & perusahaan
     * agar tampilan datatable lengkap tanpa query tambahan.
     */
    public function render()
    {
        ...
        return view('livewire.administrator.dasbor-pembimbing-sekolah', ['pembimbingData' => $pembimbingData]);
    }

    /**
     * Menampilkan modal tambah data dengan kondisi formulir bersih.
     */
    ...
    /**
     * Mengisi formulir berdasarkan pembimbing yang dipilih,
     * termasuk memuat email serta foto profil lama dari relasi user.
     */
    ...
    /**
     * Menyimpan perubahan data pembimbing sekolah.
     * Seluruh proses dibungkus `DB::transaction` supaya pembaruan user dan
     * entitas pembimbing bersifat atomik:
     * - Mode edit memperbarui akun user (termasuk password & foto bila diisi)
     *   lalu mensinkronkan identitas pembimbing.
     * - Mode tambah membuat akun user ber-role `pembimbingsekolah`, menyimpan
     *   foto ke `storage/app/public/fotos/profil`, kemudian membuat data
     *   pembimbing yang menaut ke user tersebut.
    ...
    /**
     * Menghapus data pembimbing beserta akun user dan foto profilnya.
     * Catatan: Tambahkan pengecekan relasi bila ingin mencegah penghapusan
     * pembimbing yang masih dipakai di modul lain.
     */
    ...
    /**
     * Menutup modal dan membersihkan state/error agar siap digunakan kembali.
     */
    ...
    /**
     * Reset lengkap seluruh properti formulir termasuk URL foto lama.
     */
