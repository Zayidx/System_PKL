...
/**
 * Modul admin untuk mengelola kepala program keahlian:
 * - Memadukan data profil, jurusan yang diampu, dan akun login.
 * - Memungkinkan tambah/edit akun beserta foto profil dalam satu modal.
 * - Menghapus data lama dengan aman termasuk file foto di storage.
 */
class DasborKepalaProgram extends Component
{
    ...
    /**
     * Aturan validasi agar setiap kepala program memiliki identitas unik
     * serta jurusan yang belum terpakai oleh kepala program lain.
     */
    ...
    /**
     * Mengambil daftar kepala program lengkap dengan jurusan & user,
     * serta menyiapkan opsi jurusan untuk dropdown modal.
     */
    public function render()
    {
        ...
        return view('livewire.administrator.dasbor-kepala-program', [
    ...
    /**
     * Membuka modal kosong untuk menambahkan kepala program baru.
     */
    ...
    /**
     * Mengisi formulir dengan data kepala program yang dipilih agar dapat disunting.
     */
    ...
    /**
     * Menyimpan perubahan data melalui `DB::transaction` agar sinkron antara
     * tabel user dan kepala program:
     * - Mode edit memperbarui akun user (password & foto opsional) lalu sinkron
     *   kolom identitas kepala program.
     * - Mode tambah membuat akun user ber-role `kepalaprogram`, menyimpan foto
     *   ke storage publik, kemudian membuat entri kepala program baru.
     * Setelah sukses, SweetAlert dipicu dan modal ditutup.
     */
    ...
    /**
     * Menghapus kepala program beserta akun dan foto profilnya.
     */
    ...
    /**
     * Menutup modal dan mereset input agar form kembali bersih.
     */
    ...
    /**
     * Mengembalikan seluruh properti form ke nilai awal dan menghapus error validasi.
     */
