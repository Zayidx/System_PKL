...
#[Title('Dasbor Staf Hubin')]
/**
 * Dasbor utama staf hubin:
 * - Menyajikan statistik prakerin, pengajuan terbaru, dan siswa yang belum mengajukan.
 * - Mendukung filter status/tanggal serta ekspor data prakerin dan perusahaan ke Excel.
 * - Menyediakan indikator visual untuk status pengajuan.
 */
class DasborUtama extends Component
{
    ...
    /**
     * Inisialisasi data statistik, pengajuan hari ini, dan daftar siswa tanpa pengajuan.
     */
    ...
    /**
     * Menghitung statistik utama (jumlah pengajuan, diterima, ditolak, dsb.)
     * dan menyiapkan data chart pie.
     */
    ...
    /**
     * Mengubah filter status untuk daftar histori pengajuan.
     */
    ...
    /**
     * Menghapus seluruh filter pencarian/ status / tanggal.
     */
    ...
    /**
     * Mengambil daftar pengajuan terbaru dengan menerapkan filter pencarian,
     * status, dan rentang tanggal. Dibatasi 20 entri teratas.
     */
    ...
    /**
     * Memberikan kelas CSS badge sesuai status pengajuan.
     */
    ...
    /**
     * Mengekspor data prakerin mahasiswa ke Excel berdasarkan periode pilihan.
     * Termasuk validasi periode custom dan perhitungan jumlah kolom dinamis.
     */
    ...
    /**
     * Mengosongkan filter tanggal custom setelah dipakai.
     */
    ...
    /**
     * Mengekspor daftar perusahaan beserta statistik jumlah siswa diterima
     * ke file Excel.
     */
    ...
    public function render()
    {
        ...
        return view('livewire.staf-hubin.dasbor-utama');
    }
}
